  ...
  return (
    <div className="border-b border-[var(--color-border)] last:border-b-0">
      <button
        ...
        aria-controls={id}
        className="flex w-full items-center justify-between gap-4 py-5 text-left font-semibold text-[var(--color-foreground)] transition active:scale-[0.99] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#f97316] focus-visible:ring-offset-2 rounded-lg touch-manipulation"
      >
        {pergunta}
        <span
      ...
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="mt-16 text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-[#25D366] px-6 py-4 font-bold text-white transition active:scale-[0.98] hover:bg-[#20bd5a] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 touch-manipulation"
          >
